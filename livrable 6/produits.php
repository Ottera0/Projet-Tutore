...
<section id="plants" class="plants-container">
    ...
    <div class="grid-plants">
        <a href="description_plante.php" class="plant-box grid plant-grid1">
            <div class="plant-bio">
                <h1 class="plant-name">Plante</h1>
                <h3 class="plant-price">29,99€</h3>
            </div>
        </a>
        <a href="description_plante.php" class="plant-box grid plant-grid2">
            <div class="plant-bio">
                <h1 class="plant-name">Plante</h1>
                <h3 class="plant-price">29,99€</h3>
            </div>
        </a>
        <a href="description_plante.php" class="plant-box grid plant-grid3">
            <div class="plant-bio">
                <h1 class="plant-name">Plante</h1>
                <h3 class="plant-price">29,99€</h3>
            </div>
        </a>
        <a href="description_plante.php" class="plant-box grid plant-grid4">
            <div class="plant-bio">
                <h1 class="plant-name">Plante</h1>
                <h3 class="plant-price">29,99€</h3>
            </div>
        </a>
        <a href="description_plante.php" class="plant-box grid plant-grid5">
            <div class="plant-bio">
                <h1 class="plant-name">Plante</h1>
                <h3 class="plant-price">29,99€</h3>
            </div>
        </a>
        <a href='description_plante.php' class="plant-box grid plant-grid6">
            <div class="plant-bio">
                <h1 class="plant-name">Plante</h1>
                <h3 class="plant-price">29,99€</h3>
            </div>
